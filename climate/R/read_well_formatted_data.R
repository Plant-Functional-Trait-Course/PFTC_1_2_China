...
#get_list of files
fl <- dir(path = "/Volumes/FELLES/MATNAT/BIO/Ecological and Environmental Change/TransplantChina/ClimateData/WellFormatted", recursive = TRUE, pattern = "csv$", full.names = TRUE)

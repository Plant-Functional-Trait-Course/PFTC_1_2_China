...
The data was then checked visually to detect apparent measurement errors. Unrealistic values were removed. For the trait data this included leaves with very small wet mass (< 0.0003354626), leaf dry matter values higher than 1 g/g, leaves with specific leaf area values less than 5 cm^2^ /g or greater than 500 cm^2^ /g and leaf nitrogen values higher than 6.4%. The nitrogen cutoff value was chosen based on the highest published leaf nitrogen values found in the Botanical Information and Ecology Network (Enquist et al., 2009) for the genera in our study.
